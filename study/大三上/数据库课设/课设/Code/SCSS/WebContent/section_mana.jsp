...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body" style="padding-top: 3%">
	<!-- 内容主体区域 -->
	<h2 style="padding-left: 5%;padding-bottom: 2%;">开课信息管理</h2>
	<form class="layui-form" action="section_mana_servlet" method="post" style="padding-left: 15%;font-size: 16px;">
...
layui.use('table', function(){
	...
	//监听工具条
		table.on('tool(demo)', function(obj){
		  var data = obj.data;
		  if(obj.event === 'del'){
		      window.location.href="section_mana_servlet?op=delete&data="+encodeURIComponent(JSON.stringify(data));
		  } else if(obj.event === 'edit'){
			  window.location.href="section_mana_servlet?op=update&data="+encodeURIComponent(JSON.stringify(data));
		  }
		});
...
function insert_info(){
	layer.open({
	  ...
	  shade: 0.8,
	  area: ['50%', '90%'],
	  content: 'insert_info.jsp?section_info' 
	});
}
</script>
</body>
