...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body" style="padding-top: 3%">
	<!-- 内容主体区域 -->
	<h2 style="padding-left: 5%;padding-bottom: 2%;">学生信息管理</h2>
	<form class="layui-form" action="stu_info_servlet" method="post" style="padding-left: 15%;font-size: 16px;">
...
layui.use('table', function(){
	  ...
	  table.render({
		    ...
		    ,cols: [[ //表头
		      ...
		      ,{field: 'clas', title: '年级', sort: true, width:80}
		      ,{field: 'depart_name', title: '学院', sort: true}
		      ,{field: 'major_name', title: '专业', sort: true}
	...
	//监听工具条
		table.on('tool(demo)', function(obj){
		  var data = obj.data;
		  if(obj.event === 'del'){
		      window.location.href="stu_info_servlet?op=delete&data="+encodeURIComponent(JSON.stringify(data));
		  } else if(obj.event === 'edit'){
			  window.location.href="stu_info_servlet?op=update&data="+encodeURIComponent(JSON.stringify(data));
		  }
		});
...
function insert_info(){
	layer.open({
	  ...
	  shade: 0.8,
	  area: ['50%', '90%'],
	  content: 'insert_info.jsp?student_info' 
	});
}
</script>
</body>
