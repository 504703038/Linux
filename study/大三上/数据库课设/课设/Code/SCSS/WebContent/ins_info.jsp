...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body" style="padding-top: 3%">
	<!-- 内容主体区域 -->
	<h2 style="padding-left: 5%;padding-bottom: 2%;">教师信息管理</h2>
	<form class="layui-form" action="ins_info_servlet" method="post" style="padding-left: 15%;font-size: 16px;">
		<div class="layui-form-item">
			...
			<div class="layui-inline">
		      	...
		      	<div class="layui-input-inline" style="padding-top: 2%;">
		        	<input type="tel" name="id" autocomplete="off" class="layui-input" style="height: 25px;">
		      	</div>
	   		</div>
	   		<div class="layui-inline">
	      		<label class="layui-form-label">姓名：</label>
		      	<div class="layui-input-inline" style="padding-top: 2%;">
		        	<input type="text" name="name" autocomplete="off" class="layui-input" style="height: 25px;">
		      	</div>
		    </div>
...
layui.use('table', function(){
	  ...
	  table.render({
		    ...
		    ,page: true //开启分页
		    ,cols: [[ //表头
		      {field: 'instructor_id', title: '工号', sort: true}
		      ,{field: 'instructor_name', title: '姓名'}
		      ,{field: 'depart_name', title: '学院', sort: true}
		      ,{field: 'sex', title: '性别', sort: true} 
		      ,{field: 'birthday', title: '生日', sort: true}
		      ,{field: 'id_card', title: '身份证', sort: true}
	...
	//监听工具条
		table.on('tool(demo)', function(obj){
		  var data = obj.data;
		  if(obj.event === 'del'){
		      window.location.href="ins_info_servlet?op=delete&data="+encodeURIComponent(JSON.stringify(data));
		  } else if(obj.event === 'edit'){
			  window.location.href="ins_info_servlet?op=update&data="+encodeURIComponent(JSON.stringify(data));
		  }
		});
...
function insert_info(){
	layer.open({
	  ...
	  shade: 0.8,
	  area: ['50%', '90%'],
	  content: 'insert_info.jsp?instructor_info' 
	});
}
</script>
</body>
