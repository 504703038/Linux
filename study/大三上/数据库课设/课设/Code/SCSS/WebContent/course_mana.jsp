...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body" style="padding-top: 3%">
	...
	<h2 style="padding-left: 5%;padding-bottom: 2%;">课程开设管理</h2>
	
	<form class="layui-form" action="course_mana_servlet" method="post" style="padding-left: 15%;font-size: 16px;">
		<div class="layui-form-item">
			...
			<div class="layui-inline">
		      	...
		      	<div class="layui-input-inline" style="padding-top: 2%;">
		        	<input type="tel" name="course_id" autocomplete="off" class="layui-input" style="height: 25px;">
		      	</div>
	   		</div>
	   		<div class="layui-inline">
...
layui.use('table', function(){
	...
	//监听工具条
		table.on('tool(demo)', function(obj){
		  var data = obj.data;
		  if(obj.event === 'del'){
		      window.location.href="course_mana_servlet?op=delete&data="+encodeURIComponent(JSON.stringify(data));
		  } else if(obj.event === 'edit'){
			  window.location.href="course_mana_servlet?op=update&data="+encodeURIComponent(JSON.stringify(data));
		  }
		});
...
function insert_info(){
	layer.open({
	  ...
	  shade: 0.8,
	  area: ['50%', '90%'],
	  content: 'insert_info.jsp?course_info' 
	});
}
