...
//					System.out.println("向服务器验证手机号码\n");
					String id =account_text.getText();
					if (id.equals(""))
					{
						JLabel title = new JLabel("账号不能为空。");
...
//card2组件设置
		...
		phonenumber_panel.setBackground(Color.WHITE);
		next_panel.setBackground(Color.WHITE);
		newpassword_panel.setBackground(Color.WHITE);
		confirm_newpassword_panel.setBackground(Color.WHITE);
		achieve_panel.setBackground(Color.WHITE);
